...
def design_rectangular_tank(
    ...
    # Round water depth UP to the next 250 mm so the provided volume never
    # falls below the required capacity (rounding down can short the tank).
    H_w = math.ceil(capacity_m3 / (L * B) * 4) / 4
    actual_vol = L * B * H_w
